...
<?php echo form_open("manager/edit/$id",$attributes); ?>
    ...
    <div class="form-group">
        ...
        <input type="text" name="username" value="<?php echo $username; ?>" data-original="<?php echo $username; ?>" class="form-control check-duplicate" data-type="manager" data-url="<?php echo site_url('common/check_duplicate'); ?>">
